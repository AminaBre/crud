...
const apiKey = "jB3MABE3aIJm2fLt3NykYGbzTt7oLRGw5H4kLoonONBslyLt4Q";
const url = "https://crudapi.co.uk/api/v1/task";
const dataType = "task"; // Datatype, f.eks. 'task' for å opprette en oppgave
...
const getData = async () => {
  try {
    ...
    return response.data; // Returner data hvis du trenger det videre
  } catch (error) {
    console.error(
      "Error fetching data:",
...
//createData(apiKey, dataType, newData);
